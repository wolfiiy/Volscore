...
ALTER TABLE `bookings` ADD CONSTRAINT `fk_booking_player` FOREIGN KEY (`player_id`) REFERENCES `players` (`id`);
ALTER TABLE `bookings` ADD CONSTRAINT `fk_booking_point` FOREIGN KEY (`point_id`) REFERENCES `points` (`id`);
...
ALTER TABLE `games` ADD CONSTRAINT `fk_games_teams` FOREIGN KEY (`receiving_id`) REFERENCES `teams` (`id`);
ALTER TABLE `games` ADD CONSTRAINT `fk_games_teams1` FOREIGN KEY (`visiting_id`) REFERENCES `teams` (`id`);
...
ALTER TABLE `members` ADD CONSTRAINT `fk_members_teams1` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`);
...
ALTER TABLE `players` ADD CONSTRAINT `fk_player_game` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`);
ALTER TABLE `players` ADD CONSTRAINT `fk_player_team` FOREIGN KEY (`member_id`) REFERENCES `members` (`id`);
...
ALTER TABLE `points` ADD CONSTRAINT `fk_points_sets1` FOREIGN KEY (`set_id`) REFERENCES `sets` (`id`);
ALTER TABLE `points` ADD CONSTRAINT `fk_points_teams1` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`);
...
ALTER TABLE `positions` ADD CONSTRAINT `fk_position_sets1` FOREIGN KEY (`set_id`) REFERENCES `sets` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_position_teams` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_positions_players1` FOREIGN KEY (`player_position_1_id`) REFERENCES `players` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_positions_players2` FOREIGN KEY (`player_position_2_id`) REFERENCES `players` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_positions_players3` FOREIGN KEY (`player_position_3_id`) REFERENCES `players` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_positions_players4` FOREIGN KEY (`player_position_4_id`) REFERENCES `players` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_positions_players5` FOREIGN KEY (`player_position_5_id`) REFERENCES `players` (`id`);
ALTER TABLE `positions` ADD CONSTRAINT `fk_positions_players6` FOREIGN KEY (`player_position_6_id`) REFERENCES `players` (`id`);
...
ALTER TABLE `sets` ADD CONSTRAINT `fk_sets_games1` FOREIGN KEY (`game_id`) REFERENCES `games` (`id`);
...
ALTER TABLE `substitutions` ADD CONSTRAINT `fk_player_sub` FOREIGN KEY (`player_in_id`) REFERENCES `members` (`id`);
ALTER TABLE `substitutions` ADD CONSTRAINT `fk_positions` FOREIGN KEY (`position_id`) REFERENCES `positions` (`id`);
...
ALTER TABLE `timeouts` ADD CONSTRAINT `fk_timeout_point` FOREIGN KEY (`point_id`) REFERENCES `points` (`id`);
ALTER TABLE `timeouts` ADD CONSTRAINT `fk_timeout_set` FOREIGN KEY (`set_id`) REFERENCES `sets` (`id`);
ALTER TABLE `timeouts` ADD CONSTRAINT `fk_timeout_team` FOREIGN KEY (`team_id`) REFERENCES `teams` (`id`);
